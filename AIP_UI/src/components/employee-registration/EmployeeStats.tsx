...
export const EmployeeStats = ({ employees }: EmployeeStatsProps) => {
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 lg:gap-6">
      <Card className="bg-gradient-to-br from-slate-800 via-slate-700 to-slate-800 shadow-md h-full">
      ...
      <Card className="bg-gradient-to-br from-emerald-800 via-emerald-700 to-emerald-800 shadow-md h-full">
        <CardHeader className="flex flex-row items-center justify-between p-3 sm:p-4 pb-2 space-y-0">
      ...
      <Card className="bg-gradient-to-br from-amber-800 via-amber-700 to-amber-800 shadow-md h-full">
        <CardHeader className="flex flex-row items-center justify-between p-3 sm:p-4 pb-2 space-y-0">
